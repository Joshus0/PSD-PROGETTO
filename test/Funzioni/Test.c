...
void testCase9_MultiSlotGiornoStesso(void) {
    ...
    printf(CYAN " > Fase 1: Pianificazione primo intervallo (mattina 09:00-12:00)...\n" RESET);
    ...
    printf(CYAN " > Fase 2: Pianificazione secondo intervallo (pomeriggio 14:00-17:00 - STESSO GIORNO)...\n" RESET);
    ...
    printf(CYAN " > Fase 3: Verifica agenda tecnico (contiene entrambi gli interventi)...\n" RESET);
    ...
    printf(CYAN " > Fase 4: Verifica assenza di conflitti orari...\n" RESET);
    ...
    if (r3 != NULL) {
        ...
        assert(p3 == 0); 
        assert(getStatoRichiesta(r3) == APERTA); 
